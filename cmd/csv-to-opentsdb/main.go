...
func configure(args []string) (*csv.OpenTSDBImportFormatProcess, error) {
	...
	flags := flag.NewFlagSet("opentsdb", flag.ExitOnError)
	...
	if valuesSlice, err := csv.Parse(values); err != nil {
		...
		return &csv.OpenTSDBImportFormatProcess{
...
func main() {
	var p *csv.OpenTSDBImportFormatProcess
	var err error
